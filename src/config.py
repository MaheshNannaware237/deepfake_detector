...
# ---------------------------------------------------------------------------
# Remote checkpoint download (used when deploying e.g. on Streamlit Cloud,
# where outputs/checkpoints/ is empty because .pt files aren't committed
# to the git repo). If a checkpoint is missing locally, src/inference.py
# downloads it from these GitHub Release URLs instead of failing.
#
# If you re-train and re-upload new checkpoints to a new Release, update
# these URLs to match.
# ---------------------------------------------------------------------------
CHECKPOINT_URLS = {
    "baseline": "https://github.com/MaheshNannaware237/deepfake_detector/releases/download/v1.0-checkpoints/baseline_best.pt",
    "fft": "https://github.com/MaheshNannaware237/deepfake_detector/releases/download/v1.0-checkpoints/fft_best.pt",
    "transfer": "https://github.com/MaheshNannaware237/deepfake_detector/releases/download/v1.0-checkpoints/transfer_best.pt",
}
